...
Status: authoritative and implemented V1.3 rule specification
Rule-set version: `editorial-review/1.0.0`
Approved: 2026-08-27
Implemented: 2026-08-27

Capability requirements: [capabilities/review-knowledge-change.md](capabilities/review-knowledge-change.md).
...
- Check: stored values follow [canonical-vocabulary.md](canonical-vocabulary.md), and alternative reader-facing terms do not silently create a second concept.
