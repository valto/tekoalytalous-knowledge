...
```text
Sääntö tai muuttumaton ehto
→ nimenomainen toteutusvaatimus
→ omistajan tai käyttäjän nimenomainen valinta
→ suositeltu oletusarvo
→ agentin harkinta
```
...
| Jaettu elementti | Laji | Luotu kyvykkyydelle | Hyväksytty uudelleenkäyttö | Huomio |
| --- | --- | --- | --- | --- |
