# Julkisen tietovaraston kyvykkyydet

Kyvykkyysvaatimusasiakirja kuvaa toteutustavasta riippumattoman, kokonaisen toimintakyvyn. Se ei ole sama asia kuin sivu, painike, rajapinta tai yksittäinen tietue.

Tässä julkisessa repositoriossa julkaistaan ne kyvykkyyskuvaukset, jotka ovat tarpeen avoimen tietoaineiston ymmärtämiseen ja hallintaan:

| Kyvykkyys | Tila | Kuvaus |
| --- | --- | --- |
...
| [Markkinatoimijan arviointi](evaluate-market-actor.md) | luonnos; agenttikalibrointi käynnissä | Menetelmä, pisteytysohje, kaksi synteettistä lähdepakettia sekä tulosten lukitus ja vertailu ovat valmiit. |
